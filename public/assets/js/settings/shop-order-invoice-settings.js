/**
 * Shop Order & Invoice Settings Management
 */
...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const routes = window.shopOrderInvoiceSettingsRoutes || {};

        $('#saveShopOrderInvoiceSettingsButton').on('click', function () {
            const $form = $('#shopOrderInvoiceSettingsForm');
            const $button = $(this);
            ...
            $.ajax({
                ...
                success(response) {
                    notyf.success(response.message || 'Order and invoice settings saved successfully.');
