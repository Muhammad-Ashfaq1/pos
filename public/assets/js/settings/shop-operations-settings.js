/**
 * Shop Operations Settings Management
 */
...
(function () {
    ...
    function syncBusinessHourRow($row) {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const routes = window.shopOperationsSettingsRoutes || {};
        ...
        $('#saveShopOperationsSettingsButton').on('click', function () {
            const $form = $('#shopOperationsSettingsForm');
            const $button = $(this);
            ...
            $.ajax({
                ...
                success(response) {
                    notyf.success(response.message || 'Operations settings saved successfully.');
