/**
 * Shop Notifications Settings Management
 */
...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const routes = window.shopNotificationsSettingsRoutes || {};

        $('#saveShopNotificationsSettingsButton').on('click', function () {
            const $form = $('#shopNotificationsSettingsForm');
            const $button = $(this);
            ...
            $.ajax({
                ...
                success(response) {
                    notyf.success(response.message || 'Notification settings saved successfully.');
