/**
 * Shop General Settings Management
 */
...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const routes = window.shopGeneralSettingsRoutes || {};

        $('#saveShopGeneralSettingsButton').on('click', function () {
            const $form = $('#shopGeneralSettingsForm');
            const $button = $(this);
            ...
            $.ajax({
                ...
                success(response) {
                    notyf.success(response.message || 'Shop settings saved successfully.');
