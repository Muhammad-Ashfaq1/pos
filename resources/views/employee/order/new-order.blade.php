            ...
            <div class="col-md-4">
                <div class="card shadow-sm border-0 h-100 pos-sidebar-card">
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="pos-item-list flex-grow-1 d-flex flex-column gap-2 mb-3">
                            @for ($i = 0; $i < 50; $i++)
                                ...
                                <div
                                    class="d-flex align-items-center justify-content-between flex-grow-1 bg-secondary bg-opacity-10 rounded-pill py-2 px-4 shadow-sm">

                                    <span class="fw-bold text-secondary small">Gasoline</span>

                                    <div class="d-flex align-items-center">

                                        <div class="d-flex align-items-center border-end pe-4 me-4">
                                            <button class="btn btn-sm p-0 border-0 text-secondary fw-light">—</button>
                                            <span class="mx-3 fw-bold text-dark small">24.000</span>
                                            <button class="btn btn-sm p-0 border-0 text-secondary fw-light">+</button>
                                        </div>

                                        <span class="fw-bold text-primary small">$125.000</span>
                        ...
                        <div class="mt-auto border-top pt-3">
                            ...
                            <div class="row g-2 mb-3 align-items-stretch">
                                ...
                                <div class="col-6">
                                    <button
                                        class="btn btn-primary w-100 h-100 fw-bold d-flex flex-column align-items-center cursor-pointer justify-content-center py-2"
                                        disabled>
            ...
            <div class="col-md-8">
                <div class="card shadow-sm border-0 h-100 p-4">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div
                                class="card border-0 rounded-4 text-center p-5 justify-content-center align-items-center category-card">
