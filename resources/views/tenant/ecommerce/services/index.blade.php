    ...
    <div class="pos-listing">
        <div class="pos-glass-card pos-tone-secondary pos-listing-panel">
            <div class="pos-listing-toolbar">
                <h4 class="pos-listing-title">Services</h4>
                <div class="pos-listing-search-slot" aria-hidden="true"></div>
                <div class="pos-listing-toolbar-tools">
                    <div class="pos-listing-toolbar-actions" id="serviceTableActions">
                        <div class="dropdown">
                            <button
                                type="button"
            ...
            <div class="card-datatable table-responsive pos-listing-table pt-0">
                <table class="services-datatables table table-hover align-middle">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Category</th>
        ...
        <div class="modal fade pos-listing-modal" id="serviceModal" tabindex="-1" aria-labelledby="serviceModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
            <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <form id="serviceForm" action="{{ route('tenant.ecommerce.services.save') }}" method="POST" novalidate class="d-flex flex-column h-100 overflow-hidden">
                        @csrf
