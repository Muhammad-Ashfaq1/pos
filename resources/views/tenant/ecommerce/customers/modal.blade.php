                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <div class="position-relative">
                                <select id="customer_type" name="customer_type" class="form-select select2"
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" id="customer_notes" name="notes" rows="3"
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" min="0" class="form-control" id="customer_loyalty_points_balance"
                                name="loyalty_points_balance" value="0">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="col-md-3">
