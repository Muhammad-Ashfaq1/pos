    ...
    <div class="pos-listing">
        <div class="pos-glass-card pos-tone-secondary pos-listing-panel">
            <div class="pos-listing-toolbar">
                <h4 class="pos-listing-title">Product Types</h4>
                <div class="pos-listing-search-slot" aria-hidden="true"></div>
                <div class="pos-listing-toolbar-tools">
                    <div class="pos-listing-toolbar-actions" id="productTypeTableActions">
                        <div class="dropdown">
                            <button
                                type="button"
            ...
            <div class="card-datatable table-responsive pos-listing-table pt-0">
                <table class="product-types-datatables table table-hover align-middle">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Product Type</th>
        ...
        <div class="modal fade pos-listing-modal" id="productTypeModal" tabindex="-1" aria-labelledby="productTypeModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
            <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <form id="productTypeForm" action="{{ route('tenant.ecommerce.product-types.save') }}" method="POST" novalidate class="d-flex flex-column h-100 overflow-hidden">
                        @csrf
                        ...
                        <div class="modal-footer flex-shrink-0">
                            ...
                            <button type="submit" class="btn btn-primary" id="productTypeSubmitBtn" data-create-text="Save Product Type" data-update-text="Update Product Type">
                                Save Product Type
                            </button>
                        </div>
                    </form>
...
@section('scripts')
    ...
    <script>
        window.productTypeListingUrl = @json($listingUrl);
    </script>
    <script src="{{ asset('assets/js/pos-listing-toolbar.js') }}?v={{ filemtime(public_path('assets/js/pos-listing-toolbar.js')) }}"></script>
    <script src="{{ asset('assets/js/tenant/e-com/product-types.js') }}?v={{ filemtime(public_path('assets/js/tenant/e-com/product-types.js')) }}"></script>
@endsection
