...
@section('content')
    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 mb-4">
        {{-- <div>
            <h4 class="mb-1">Product Types</h4>
        ...
        <div class="d-flex align-items-center gap-2" id="productTypeTableActions">
            <div class="dropdown">
                <button
                    type="button"
    ...
    <div class="card">
        <div class="card-datatable table-responsive pt-0">
            <table class="product-types-datatables table">
    ...
    <div class="modal fade" id="productTypeModal" tabindex="-1" aria-labelledby="productTypeModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
