...
class CustomerController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('employee.customers.index', [
            'listingUrl' => route('employee.customers.listing'),
            'editUrlTemplate' => route('employee.customers.edit', ['customer' => '__CUSTOMER__']),
            'customerTypes' => Customer::typeOptions(),
            'vehicleIndexUrlTemplate' => route('employee.vehicles.index', ['customer_id' => '__CUSTOMER__']),
        ]);
    }
