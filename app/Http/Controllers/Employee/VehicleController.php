...
class VehicleController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('employee.vehicles.index', [
            'listingUrl' => route('employee.vehicles.listing'),
            'editUrlTemplate' => route('employee.vehicles.edit', ['vehicle' => '__VEHICLE__']),
            ...
            'vehicleSaveUrl' => route('employee.vehicles.save'),
        ]);
    }
