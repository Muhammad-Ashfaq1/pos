...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Role::findByName(User::TENANT_ADMIN)->syncPermissions([
            ...
            Permission::findByName('product-type.view', 'web'),
            Permission::findByName('product-type.create', 'web'),
            Permission::findByName('product-type.update', 'web'),
            Permission::findByName('product-type.delete', 'web'),
            ...
            Permission::findByName('returns.view', 'web'),
            Permission::findByName('refunds.manage', 'web'),
            Permission::findByName('discount.manage', 'web'),
            Permission::findByName('discount.apply_bill', 'web'),
            Permission::findByName('discount.apply_item', 'web'),
            Permission::findByName('discounts.manage', 'web'),
            Permission::findByName('discount-group.view', 'web'),
            Permission::findByName('discount-group.manage', 'web'),
            Permission::findByName('cards.view', 'web'),
            Permission::findByName('cards.create', 'web'),
            Permission::findByName('cards.update', 'web'),
            Permission::findByName('cards.delete', 'web'),
            Permission::findByName('cards.manage', 'web'),
            Permission::findByName('customer.view', 'web'),
            Permission::findByName('customer.create', 'web'),
            Permission::findByName('customer.update', 'web'),
            Permission::findByName('customer.delete', 'web'),
            ...
            Permission::findByName('vehicle.delete', 'web'),
